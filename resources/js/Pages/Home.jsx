 ...
 return <MainLayout>
  <section className="relative overflow-hidden">
    ...
    <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-20 md:grid-cols-2 lg:px-8 lg:py-28">
      ...
      <div className="rounded-3xl border border-cyan-300/20 bg-cyan-300/10 p-6 shadow-2xl"><img src={pageImages.home} alt="Ronīši plakāts" className="aspect-video w-full rounded-2xl object-cover" loading="lazy"/><div className="mt-6 grid gap-4 sm:grid-cols-3"><Info n="01" t="Sports"/><Info n="02" t="Komandas"/><Info n="03" t="Atpūta"/></div></div>
    </div>
  </section>
