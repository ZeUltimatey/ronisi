...
export default function Contacts(){return <PageShell title="KONTAKTI" subtitle="Sazinies ar mums.">
  <p className="mb-8 max-w-3xl text-slate-300">Neskaidrību gadījumā raksti, kā arī seko līdzi Facebook Event - RTU rudens sporta spēles “Ronīši” 2026 un iepazīsties ar sporta spēļu nolikumu.</p>
